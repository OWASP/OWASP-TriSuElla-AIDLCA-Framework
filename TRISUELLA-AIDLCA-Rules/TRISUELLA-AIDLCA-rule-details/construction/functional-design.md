...
- Read unit definition from `TRISUELLA-AIDLCA-docs/inception/application-design/unit-of-work.md`
- Read assigned stories from `TRISUELLA-AIDLCA-docs/inception/application-design/unit-of-work-story-map.md`
...
### Step 4: Store Plan
- Save as `TRISUELLA-AIDLCA-docs/construction/plans/{unit-name}-functional-design-plan.md`
...
- Create `TRISUELLA-AIDLCA-docs/construction/{unit-name}/functional-design/business-logic-model.md`
- Create `TRISUELLA-AIDLCA-docs/construction/{unit-name}/functional-design/business-rules.md`
- Create `TRISUELLA-AIDLCA-docs/construction/{unit-name}/functional-design/domain-entities.md`
- If unit includes frontend/UI: Create `TRISUELLA-AIDLCA-docs/construction/{unit-name}/functional-design/frontend-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `TRISUELLA-AIDLCA-docs/construction/[unit-name]/functional-design/`
...
- Mark Functional Design stage complete in TRISUELLA-AIDLCA-state.md
